...
- 명시적 타입 선언 사용
- 같은 패키지에서 여러 클래스를 사용하는 경우 와일드카드 import(`*`)로 줄여서 사용
- interface 우선 사용
...
- 아키텍처: 3-tier (React → Spring Boot → AWS Bedrock)
- 스트리밍 방식: SSE (Server-Sent Events)
- 세션 저장: H2 인메모리 DB + Spring Data JPA (개발/테스트용)
